...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'FN:Idham Admin\n' 
            + 'ORG: Pengembang XBot;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=6285294959195:+62 852-9495-9195\n' 
            + 'END:VCARD' 
blocked = []   
prefix = '#'
limitawal = 0
...
/******** OWNER NUMBER**********/
const ownerNumber = ["6285294959195@s.whatsapp.net","6285294959195@s.whatsapp.net"] 
/************************************/
...
const client = new WAConnection()
   ...
   console.log(color('[','white'),color('∆','red'),color(']','white'),color('qr already scan.subscribe','white'),color('YOU','red'),color('TUBE','white'),color('Idham','yellow'))
})
